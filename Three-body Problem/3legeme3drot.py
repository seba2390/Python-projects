...
##startbetingelser###
r1_0, r2_0, r3_0 = [1,1,1], [1,-0.5,0], [1,-1,0]
v1_0, v2_0, v3_0 = [0.2,0.1,1], [0,-0.33,0], [0,0,0]
...
r1_x, r1_y, r1_z, r2_x, r2_y, r2_z, r3_x, r3_y, r3_z = shorten_frames(8, r1_x, r1_y, r1_z, r2_x, r2_y, r2_z, r3_x, r3_y, r3_z)         
...
ax1.set_xlim(-1.8,4), ax1.set_ylim(-1.8,4), ax1.set_zlim(-0.5,10)


anim = animation.FuncAnimation(fig, 
                               update, 
                               init_func=init,
                               fargs = (mass1_line, mass2_line, mass3_line, mass1_dot, mass2_dot, mass3_dot,
                                        r1_x, r1_y, r1_z, r2_x, r2_y, r2_z, r3_x, r3_y, r3_z),
                               frames=len(r1_x), 
                               interval=1,
                               blit=True)
