...
class HoneyBee:
    def __init__(self,kind):
        self.kind = kind
        assert kind in ["EmployedBee","OnlookerBee","ScoutBee"], f"Undefined kind of Bee."
        self.food_source = None
        self.nectar      = None

    def setFoodSource(self,food_source):
        self.getFoodSource = food_source

    def getFoodSource(self):
        return self.food_source
    
    def setNectar(self,nectar):
        self.nectar = nectar
...
class ArtificialBeeColony:
    ...
    def __init__(self, func, Dimensions_bounds, Nr_bees, Nr_iterations, 
        ...
        self.probabilities   = self.initializeProbabilities() 
    ...
    def updateProbabilities(self):
        self.probabilities = np.array([self.nectars[i] / np.sum(self.nectars) for i \
                                                    in range(len(self.nectars))])
